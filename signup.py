...
def addsong():
    ...
    headingLabel = tk.Label(headingFrame1, text="Please Sign Up First", font='Helvetica 14 bold', bg="#FAFAD2", fg='black')
    headingLabel.place(relx=0, rely=0, relwidth=1, relheight=1)

    labelFrame = tk.Frame(root, bg="#1abc9c")
    labelFrame.place(relx=0.1, rely=0.4, relwidth=0.8, relheight=0.4)

    lb1 = tk.Label(labelFrame, text="Email id:", font='Helvetica 13 bold', bg="#1abc9c", fg='white')
    ...
    lb2 = Label(labelFrame, text="Username:", font='Helvetica 13 bold', bg="#1abc9c", fg='white')
    ...
    lb3 = Label(labelFrame, text="Password:", font='Helvetica 13 bold', bg="#1abc9c", fg='white')
    ...
    lb4 = Label(labelFrame, text="Confirm Password:", font='Helvetica 13 bold', bg="#1abc9c", fg='white')
    ...
    SubmitBtn = Button(root, text="Submit", font='Helvetica 12 bold', bg='#FF5733', fg='white', command=songadd)
